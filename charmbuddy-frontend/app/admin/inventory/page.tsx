  ...
  return (
    <div className="space-y-[12px]">
      <section className="rounded-[18px] border border-black/10 bg-white/70 p-[12px]">
        <h1 className="font-fanlste text-[30px] tracking-[1px]">Inventory Movements</h1>
        <p className="font-satoshi text-[14px] text-black/65">Riwayat stok masuk, keluar, dan penyesuaian.</p>
      </section>
