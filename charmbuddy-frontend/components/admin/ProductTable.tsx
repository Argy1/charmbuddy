...
function ActionButton({
  ...
  return (
    <motion.button
      className={`rounded-[10px] px-[12px] py-[6px] font-satoshi text-[13px] tracking-[0.8px] ${
  ...
  if (products.length === 0) {
    return (
      <div className="rounded-[20px] border border-black/10 bg-white/75 p-[16px]">
        <p className="font-satoshi text-[16px] text-black/70">Belum ada produk.</p>
      </div>
    );
  }
        ...
        <table className="w-full min-w-[760px] border-collapse">
          <thead>
            <tr className="border-b border-black/10 bg-[#8798ff]/20 text-left">
              <th className="px-[12px] py-[10px] font-satoshi text-[13px] tracking-[1px]">Name</th>
              <th className="px-[12px] py-[10px] font-satoshi text-[13px] tracking-[1px]">Category</th>
              <th className="px-[12px] py-[10px] font-satoshi text-[13px] tracking-[1px]">Price</th>
              <th className="px-[12px] py-[10px] font-satoshi text-[13px] tracking-[1px]">Stock</th>
              <th className="px-[12px] py-[10px] font-satoshi text-[13px] tracking-[1px]">Weight</th>
      ...
      <div className="grid grid-cols-1 gap-[10px] md:hidden">
        {products.map((product) => (
          <article className="rounded-[16px] border border-black/10 bg-white/80 p-[12px]" key={product.id}>
            <p className="font-fanlste text-[24px] tracking-[1px]">{product.name}</p>
