      ...
      <motion.div className="mt-[19px] w-full rounded-[20px] border border-black bg-white p-[16px]" whileHover={{ y: -2 }}>
        <div className="w-full overflow-x-auto">
          <div className="min-w-[1040px]">
            <div className="grid h-[59px] grid-cols-[120px_255px_220px_180px_150px_180px] items-center rounded-[10px] bg-[linear-gradient(270deg,rgba(141,142,153,0)_0.1%,#EBEDFF_100%)] pl-[10px] font-satoshi text-[24px] leading-[normal] text-black">
              <p>Order ID</p>
            ...
            <div className="mt-[15px] flex flex-col gap-[10px]">
              {orders.length === 0 ? (
                ...
                orders.map((order) => (
                  <button
                    className="grid h-[29px] w-full grid-cols-[120px_255px_220px_180px_150px_180px] items-center rounded-[8px] font-satoshi text-[16px] font-normal leading-[normal] tracking-[2px] text-black transition-colors hover:bg-black/5"
                    key={order.id}
                    onClick={() => {
